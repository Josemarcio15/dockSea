...
<div class="flex flex-col gap-1">
  ...
  <input
    id="config-network"
    type="text"
    class="w-full px-3.5 py-2 text-xs border border-slate-200 dark:border-slate-800 rounded-xl bg-slate-50 dark:bg-[#0e2536] text-slate-800 dark:text-slate-200 placeholder-slate-400 focus:border-violet-500 focus:outline-none transition-colors"
